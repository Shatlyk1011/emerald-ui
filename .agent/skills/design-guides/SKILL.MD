...
2. **Technical Correctness**
   Real, jsx/tailwind code — not mockups.
...
* Use tailwind colors exclusively
* Prefer:
...
* JSX/TAILWIND: Prefer tailwind with jsx syntax
* React: Functional components, composable styles
* Animation: Framer Motion or GSAP only when justified depending on provided code
