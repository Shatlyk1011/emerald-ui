...
void mainImage(out vec4 o, vec2 C) {
  ...
  float luminance = dot(colr, vec3(0.2126, 0.7152, 0.0722));
  float alpha = max(uAlphaFloor, smoothstep(0.015, 0.22, luminance));
  o = vec4(colr, alpha * uOpacity);
}
...
const Lightfall = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`lightfall-container relative h-full w-full overflow-hidden ${className}`}
      style={{
