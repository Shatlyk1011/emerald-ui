...
function SiteCard({
  ...
  return (
    <div className="group relative flex flex-col gap-3 cursor-pointer">
      {/* Card Image Area */}
      <div className="relative aspect-4/3 w-full bg-card rounded-xl overflow-hidden border border-white/5 group-hover:border-white/10 transition-colors shadow-lg">
