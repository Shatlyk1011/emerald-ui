...
function FooterKeepItTouch({ className }: FooterProps) {
  return (
    <footer
      ...
      id='contact'
    >
      <div className='container mx-auto px-6 pt-12 pb-6 max-md:px-4 max-md:pt-8 max-md:pb-4'>
        <div className='mb-12 flex items-center gap-4 max-md:mb-8 max-md:gap-2'>
          <ArrowRight className='size-6 -rotate-45 max-md:size-5' />
          <p className='text-lg font-medium md:text-xl'>Contact</p>
        </div>

        <div className='mb-10'>
          <h1 className='text-8xl font-light tracking-tight max-lg:text-7xl max-md:text-5xl'>
            Keep in touch
          </h1>
        </div>
        ...
        <div className='py-16 max-md:py-12'>
          ...
          <h2 className='bg-linear-to-r from-emerald-500 to-emerald-300 bg-clip-text text-6xl font-semibold text-transparent max-lg:text-5xl max-md:text-4xl'>
            emerald-ui@notreal.email
          </h2>
        </div>

        <div className='flex gap-16 max-lg:gap-12 max-md:flex-col'>
          <div className='w-2/3 flex-4 shrink-0 max-md:w-full'>
            <div className='mb-8'>
                ...
                <div key={idx} className='flex flex-1 flex-col'>
                  {column.map((location) => (
                    <div key={location.city} className='mb-12 lg:mb-16'>
                      <h3 className='mb-3 text-3xl font-normal max-md:text-2xl'>
                        {location.city}
                      </h3>
                      ...
                      <a
                        href='#'
                        className='mt-8 flex items-center gap-4 text-zinc-400 transition-colors hover:text-zinc-600 dark:text-zinc-500 dark:hover:text-zinc-300'
                      >
                        View on map{' '}
