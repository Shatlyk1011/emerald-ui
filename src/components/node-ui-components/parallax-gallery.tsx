...
export default function TwoWayParallax({ images = DEMO }: Props) {
  ...
  return (
    <section className='w-full pb-[10vh]'>
      <div className='pb-[10vh] text-center text-2xl font-medium'>
        Scroll Down
      </div>

      <div
        ref={gallery}
        className='flex h-[180vh] gap-4 overflow-hidden p-4 py-10 dark:bg-gray-800'
      >
        <Column
      ...
      <p className='mt-50 text-center leading-relaxed'>
