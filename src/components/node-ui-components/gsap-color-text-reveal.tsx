...
function ColorTextReveal({
  ...
  const splitRefs = useRef<Array<{ wordSplit: SplitText; charSplit: SplitText }>>([]);
  ...
  if (React.Children.count(children) === 1 && React.isValidElement(children)) {
    ...
    return React.cloneElement(children as React.ReactElement<Record<string, unknown>>, { ref: containerRef });
  }
...
export default function ColorTextRevealDemo () {
  ...
  return (
    <section className='relative bg-background'>
      {/* Hero Section */}
      <div className="py-20 relative w-full overflow-hidden h-[50vh]">
        <div className="w-full h-full flex flex-col justify-center items-center text-center px-8">
          ...
          <p className="text-xl opacity-80 max-w-2xl">
            Experience smooth character-by-character color transitions with scroll-triggered animations
          </p>
        </div>
      </div>

      {/* First Fact Section */}
      <div className="flex items-center min-h-svh relative w-full overflow-hidden bg-background py-20">
        <div className="w-full flex justify-center items-center text-center px-8">
          <div className="w-[70%] max-md:w-[85%] max-sm:w-[95%]">
            <ColorTextReveal>
              <p className="text-foreground text-center text-3xl font-black leading-tight mb-8">
      ...
      {/* Ending Section */}
      <div className="h-[20vh] w-full flex flex-col items-center justify-center relative overflow-hidden">
