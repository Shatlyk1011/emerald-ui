...
export default function GsapScrollTextReveal () {
  ...
  useGSAP(() => {
    const animeTextParagraphs = sectionRef.current?.querySelectorAll(".anime-text p");
    ...
    animeTextParagraphs.forEach((paragraph) => {
      ...
      const text = originalTextRef.current.get(paragraph) || paragraph.textContent;
    ...
    const animeTextContainers = sectionRef.current?.querySelectorAll(".anime-text-container");
  ...
  return (
    <section ref={sectionRef} className='relative'>
      {/* Hero Section */}
      <div className="py-20 relative w-full overflow-hidden h-[70vh] ">
        <div className="w-full h-full flex flex-col justify-center items-center text-center px-8">
          ...
          <p className="text-xl opacity-80 max-w-2xl">
            Experience the power of scroll-triggered animations with word-by-word reveals and keyword highlighting
          </p>
        </div>
      </div>

      {/* First Fact Section */}
      <div className="anime-text-container flex items-center h-svh relative w-full overflow-hidden">
        <div className="w-full h-full flex justify-center items-center text-center px-8">
          <div className="anime-text w-[70%] max-md:w-[85%] max-sm:w-[95%]">
            <p>
              The average human attention span has decreased from 12 seconds in 2000 to just 8 seconds today. 
              This makes vibrant and interactive storytelling more crucial than ever for capturing user engagement 
      ...
      <div className="anime-text-container flex items-center h-svh relative w-full overflow-hidden">
        <div className="w-full h-full flex justify-center items-center text-center px-8">
          <div className="anime-text w-[70%] max-md:w-[85%] max-sm:w-[95%]">
            <p>
              Studies show that users form an opinion about a website in just 50 milliseconds. 
              The shape and expression of your interface can make or break user trust, making 
              intuitive design and living animations essential for modern web experiences.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Ending Section */}
      <div className="h-[50vh] w-full flex flex-col items-center justify-center relative overflow-hidden">
        <h2 className="text-4xl md:text-4xl font-black mb-4 ">
