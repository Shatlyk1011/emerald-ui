    ...
    <div className="group relative w-full max-w-sm overflow-hidden rounded-2xl border border-zinc-200 bg-white transition-all duration-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900">
      <div className="p-5">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-zinc-600 dark:bg-zinc-800 text-xl font-semibold text-white">
            {logo || "D"}
          </div>
          <div>
      ...
      <form onSubmit={submit} className="mt-2 flex items-center justify-between border-t border-zinc-200 px-5 py-4 dark:border-zinc-800">
