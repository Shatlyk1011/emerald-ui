      ...
      <div className='flex-1 flex justify-center'>
        <div className="relative max-w-lg z-10 w-full space-y-8 max-md:space-y-5 rounded-2xl p-8 max-sm:p-5 shadow-2xl backdrop-blur-xl">
          ...
          <div className="space-y-2 text-center">
            <h2 className="text-3xl font-semibold max-md:text-2xl">Create your account</h2>
            <p className="text-sm text-foreground/70">
              Already have an account?{" "}
              <Link href="/sign-in" className="text-blue-600 dark:text-blue-400 hover:text-blue-500/80 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
