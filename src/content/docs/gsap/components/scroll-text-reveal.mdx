...
import ScrollTextReveal from '@/components/emerald-ui-components/gsap-components/scroll-text-reveal'

<Preview link='gsap-components/scroll-text-reveal' comment={['gsap']} isReload isBlock>
  <ScrollTextReveal />
</Preview>
