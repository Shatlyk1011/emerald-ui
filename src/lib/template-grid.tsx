    ...
    <div className=''>
      <div className='mb-16 grid grid-cols-1 gap-8 md:grid-cols-2'>
        <div className='rounded-lg'>
          <h2 className='flex items-center gap-2 text-sm font-semibold tracking-wider text-zinc-900 uppercase dark:text-white'>
            {columnOneData.title}
          </h2>
      ...
      <div className='mb-12'>
        <h2 className='mb-4 flex items-center gap-2 text-sm font-semibold tracking-wider text-zinc-900 uppercase dark:text-white'>
          {technologies.title}
        </h2>
